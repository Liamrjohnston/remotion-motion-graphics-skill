...
The foundation. It owns the mandatory format/background intake, approved-reference review, mobile readability, restrained material recipes, concept selection, first-pass rejection gate, and the repository-wide zero-neon/zero-glow policy. It includes the single most important text rule in the system:
...
5. **Private rejection gate + QA** — reject any neon/glow, generic AI styling, invented identity, tiny text, or reference mismatch; typecheck, compare stills, inspect the MP4, and show only the strongest pass.
